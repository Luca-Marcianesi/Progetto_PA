...
----
### .ENV
File **.env** di esempio da inserire allo stesso livello di src
```
# Postgres
POSTGRES_USER= ...
POSTGRES_PASSWORD=...
...
Inoltre bisogna aggiungere una cartella "key" allo stesso livello di "src" contenete la chiave pubblica e privata per l'agoritmo **JWT**

### Fase di sviluppo

Vengono montate le cartelle locali per l'hot reload
